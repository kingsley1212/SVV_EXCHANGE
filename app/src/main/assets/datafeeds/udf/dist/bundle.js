!function (e, t) {
    ...
    "use strict";
    var s = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (e, t) {
        e.__proto__ = t
    } || function (e, t) {
    ...
    var i = function () {
        function e(e, t) {
            this._datafeedUrl = e, this._requester = t, this.lastBarTime = null, o.t = null;
        }

        return e.prototype.getBars = function (e, t, r, s, d = []) {

            var o = this, i = {symbol: e.ticker || "", resolution: widget.symbolInterval().interval, from: r, to: s};
            if (o.t != t) {
                o.lastBarTime = null;
                o.lastBar = null;
                o.newBar = null;
            ...
            return new Promise(function (a, u) {
                if (d.length === 2) {
                    ...
                    if (n.time > o.lastBarTime + t * 60 * 1000 && o.newBar) {
                        // console.log(333);
                        o.lastBar = o.newBar;
                    }
                    var ts = [], r = {noData: !1};
                    o.newBar = n;
                    if (o.newBar.time != o.lastBar.time) {
                        n.open = o.lastBar.close;
                    }else if(o.newBar.time == o.lastBar.time){
                        n.open = o.lastBar.open;
                    }

                    n.high = Math.max(n.open,n.high,n.low);
                    n.low = Math.min(n.open,n.high,n.low);

                    // console.log(o.lastBar.time,n.time)
                    ts.push(o.lastBar);
                    ts.push(n);
                    o.lastBarTime = o.lastBar.time;
                    a({bars: ts, meta: r});

                } else {
                    o._requester.sendRequest(o._datafeedUrl, "app/exchange/exchange_tradejson/get", i).then(function (e) {
                        if ("ok" === e.s || "no_data" === e.s) {
                            var t = [], r = {noData: !1};
                            if ("no_data" === e.s) r.noData = !0, r.nextTime = e.nextTime; else for (var s = void 0 !== e.d, l = void 0 !== e.d, i = 0; i < e.d.length; ++i) {
                                var n = {
                                    time: 1e3 * e.d[i][0],
                                    close: Number(e.d[i][4]),
                                    open: Number(e.d[i][4]),
                                    high: Number(e.d[i][4]),
                                    low: Number(e.d[i][4])
                                };
                                l && (n.open = Number(e.d[i][1]), n.high = Number(e.d[i][2]), n.low = Number(e.d[i][3])), s && (n.volume = Number(e.d[i][5])), t.push(n)
                            }
                            a({bars: t, meta: r})
                            if (0 !== t.length && t.length > 1) {
                                var s = t[t.length - 1];
                                if (o.lastBarTime === null || s.timer > o.lastBarTime) {
                                    o.lastBarTime = s.time, o.lastBar = s;
                                    o.newBar = null;
                                }
        ...
        return e.prototype.subscribeBars = function (e, t, r, s) {
        ...
        }, e.prototype._updateDataForSubscriber = function (t, d = []) {
            ...
            return this._historyProvider.getBars(e.symbolInfo, e.resolution, o, s, d).then(function (e) {
        ...
        return e.prototype.resolveSymbol = function (t) {
            ...
            try {
                for (var o = r.symbol.length, i = void 0 !== r.ticker; s < o; ++s) {
                    var n = r.symbol[s], a = f(r, "exchange-listed", s), u = f(r, "exchange-traded", s),
                        c = u + ":" + n, l = i ? f(r, "ticker", s) : n, h = {
                            ticker: l,
                            name: n,
                            base_name: [a + ":" + n],
                            full_name: c,
    ...
    var o = function () {
        ...
        return e.prototype.onReady = function (e) {
            ...
            this._configuration.supports_time && this._send("app/exchange/exchange_market/time").then(function (e) {
                var t = parseInt(e);
                isNaN(t) || r(t)
            }).catch(function (e) {
            ...
            if (this._configuration.supports_group_request) {
                ...
                this._send("app/exchange/exchange_market/getchartinfo", i).then(function (e) {
    ...
    var h = function () {
        ...
        return e.prototype.getQuotes = function (e) {
            var s = this;
            return new Promise(function (t, r) {
                s._requester.sendRequest(s._datafeedUrl, "quotes", {symbols: e}).then(function (e) {
