...
import com.svv.jys.code.common.entity.TradeAccountRecordEntity;
...
public class TradeAccountAdapter extends MBaseAdapter<TradeAccountAdapter.ViewHolder>{
    private List<TradeAccountRecordEntity.RowsBean> list;
    private Context context;
    public TradeAccountAdapter(Context context,List<TradeAccountRecordEntity.RowsBean> list){
    ...
    public void setData(List<TradeAccountRecordEntity.RowsBean> list){
        this.list=list;
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        TradeAccountRecordEntity.RowsBean bean=list.get(position);
