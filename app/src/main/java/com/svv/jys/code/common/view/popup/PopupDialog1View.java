...
public class PopupDialog1View {
    private Context context;
    private PopupWindow popupWindow;
    private int width, height;
    public View parentView;

    private TextView dialogContent, leftBtn, rightBtn;
    ...
    public PopupDialog1View(Context context, MClickLisnener clickLisnener) {
    ...
    private void initPopupWindow() {
        View popView = LayoutInflater.from(context).inflate(R.layout.popup_dialog1view, null);
     ...
     * 显示popWindow
     */
    public void showPop(View parent, String msg, String leftBtnText, String rightBtnText) {
