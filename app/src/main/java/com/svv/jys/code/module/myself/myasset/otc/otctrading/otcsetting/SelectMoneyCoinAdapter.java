...
public class SelectMoneyCoinAdapter extends MBaseAdapter<SelectMoneyCoinAdapter.ViewHolder>{
    private Context context;
    private List<AdvSettingEntity.CurrencyBean> list;
    public SelectMoneyCoinAdapter(Context context, List<AdvSettingEntity.CurrencyBean> list){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tv_coin_name.setText(list.get(position).getName_cn_jt()+"("+list.get(position).getCurrency_code()+")");
