...
public class SuoCangBusinessAssetAdapter extends MBaseAdapter<SuoCangBusinessAssetAdapter.MyAssetViewHolder> {
    ...
    public SuoCangBusinessAssetAdapter(Context context, List<HomeAssatEntity.Rows> allList) {
    ...
    @Override
    public SuoCangBusinessAssetAdapter.MyAssetViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new SuoCangBusinessAssetAdapter.MyAssetViewHolder(inflater.inflate(R.layout.item_suocang_count, parent,false));
    }

    @Override
    public void onBindViewHolder(SuoCangBusinessAssetAdapter.MyAssetViewHolder holder, int position) {
