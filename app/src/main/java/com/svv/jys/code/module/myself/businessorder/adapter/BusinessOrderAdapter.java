package com.svv.jys.code.module.myself.businessorder.adapter;
...
public class BusinessOrderAdapter extends MBaseAdapter<BusinessOrderAdapter.ViewHolder>{
    private Context context;
    private List<OtcOrderEntity.RowsBean> list;
    public BusinessOrderAdapter(Context context, List<OtcOrderEntity.RowsBean> list){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        ...
        holder.tv_time.setText(context.getString(R.string.BusinessOrderAct_time)+ ToolUtils.timeStamp2String(rowsBean.getAdd_time(),"yyyy-MM-dd "));
        holder.tv_num.setText(context.getString(R.string.BusinessOrderAct_sl)+rowsBean.getNum()+rowsBean.getCoin_name());
        holder.tv_total.setText(context.getString(R.string.BusinessOrderAct_all_price)+rowsBean.getAmount()+rowsBean.getCurrency());
        holder.tv_price.setText(context.getString(R.string.BusinessOrderAct_single_price)+rowsBean.getPrice()+rowsBean.getCurrency());
