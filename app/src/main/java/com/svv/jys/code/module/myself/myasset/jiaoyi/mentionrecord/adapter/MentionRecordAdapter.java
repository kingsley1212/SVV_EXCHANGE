package com.svv.jys.code.module.myself.myasset.jiaoyi.mentionrecord.adapter;
...
public class MentionRecordAdapter extends MBaseAdapter<MentionRecordAdapter.ViewHolder> {
    private Context context;
    private List<MentionRecordEntity.RowsBean> list;
    public MentionRecordAdapter(Context context,List<MentionRecordEntity.RowsBean> list){
        this.list=list;
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, final int position) {
        ...
        holder.cancel_tv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((MentionRecordAct)context).deleteItem(position,rowsBean.getId());
            }
        });
    }
