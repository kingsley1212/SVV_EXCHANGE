...
public class LtTransferRecordAdapter extends MBaseAdapter<LtTransferRecordAdapter.ViewHolder>{
    private List<LtTransferRecord.RowsBean> list;
    private Context context;
    public LtTransferRecordAdapter(Context context, List<LtTransferRecord.RowsBean> list){
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        LtTransferRecord.RowsBean bean=list.get(position);
        ...
        holder.tv_record_type.setText(context.getString(R.string.countdetailact_item_type)+"："+bean.getType());
        holder.tv_record_mone.setVisibility(View.GONE);
    }
