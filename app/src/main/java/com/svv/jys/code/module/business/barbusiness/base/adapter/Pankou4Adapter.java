...
public class Pankou4Adapter extends MBaseAdapter<RecyclerView.ViewHolder> {
    ...
    public Pankou4Adapter(List<FPankouEntity> list, Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new Pankou4ViewHolder(inflater.inflate(R.layout.item_pankou4, null));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        switch (getItemViewType(position)) {
            case IS_TITLE:
                ...
                break;
            default:
                ((Pankou4ViewHolder) holder).bindData(allList.get(position), position);
                break;
        }
    }
    ...
    class Pankou4ViewHolder extends RecyclerView.ViewHolder {
        private TextView pankouNo;

        public Pankou4ViewHolder(View itemView) {
            super(itemView);
