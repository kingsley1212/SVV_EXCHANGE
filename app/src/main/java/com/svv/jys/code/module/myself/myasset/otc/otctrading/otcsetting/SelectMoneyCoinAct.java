...
public class SelectMoneyCoinAct extends BaseAcitvity{
    ...
    public void baseInitialization() {
        ...
        list=advSettingEntity.getCurrency();
    }
    ...
    public void viewInitialization() {
        ...
        SelectMoneyCoinAdapter adapter=new SelectMoneyCoinAdapter(this,list);
        rv_selectcoin.setAdapter(adapter);
        adapter.setOnItemClick(new MBaseAdapter.MOnItemClickListener() {
            @Override
            public void onItemClick(int position, Object o) {
                Intent intent=new Intent();
                intent.putExtra("selectmoneycoin",list.get(position));
