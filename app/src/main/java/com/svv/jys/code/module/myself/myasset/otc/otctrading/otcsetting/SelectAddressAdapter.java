...
public class SelectAddressAdapter extends MBaseAdapter<SelectAddressAdapter.ViewHolder>{
    private Context context;
    private List<AdvSettingEntity.CountryBean> list;
    public SelectAddressAdapter(Context context, List<AdvSettingEntity.CountryBean> list){
    ...
    public void onBindViewHolder(ViewHolder holder, final int position) {
        holder.tv_coin_name.setText(list.get(position).getChinese()+"("+list.get(position).getName()+")");
