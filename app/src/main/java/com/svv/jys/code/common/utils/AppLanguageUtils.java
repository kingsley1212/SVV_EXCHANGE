...
public class AppLanguageUtils {
    ...
    public static HashMap<String, Locale> mAllLanguages = new HashMap<String, Locale>(8) {{
        put(ACEConstant.LANGUAGE_SIMPLIFIED_CHINESE, Locale.SIMPLIFIED_CHINESE);
        put(ACEConstant.LANGUAGE_TRADITIONAL_CHINESE, Locale.TRADITIONAL_CHINESE);
        put(ACEConstant.LANGUAGE_ENGLISH, Locale.ENGLISH);
    }};
    ...
    public static String getSupportLanguage(String language) {
        ...
        return ACEConstant.LANGUAGE_TRADITIONAL_CHINESE;
    }
