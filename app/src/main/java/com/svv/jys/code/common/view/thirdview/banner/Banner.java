...
import com.svv.jys.code.common.view.thirdview.banner.listener.OnBannerClickListener;
import com.svv.jys.code.common.view.thirdview.banner.view.ArcShapeView;
import com.svv.jys.code.common.view.thirdview.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    private int mIndicatorSelectedResId = R.mipmap.indicator_light_long;
    private int mIndicatorUnselectedResId = R.mipmap.indicator_light_dot;
