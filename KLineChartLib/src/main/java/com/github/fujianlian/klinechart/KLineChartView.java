    ...
    private void initAttrs(AttributeSet attrs) {
        ...
        if (array != null) {
            try {
                ...
                setMTextColor(array.getColor(R.styleable.KLineChartView_kc_text_color, getColor(R.color.chart_mt_txcolor)));
                ...
                setSelectedXLineColor(Color.parseColor("#8040424D"));
